...
COPY ["src/Play.Inventory.Services/Play.Inventory.Service.csproj", "src/Play.Inventory.Services/"]
...
RUN dotnet restore "src/Play.Inventory.Services/Play.Inventory.Service.csproj"
COPY ./src ./src
